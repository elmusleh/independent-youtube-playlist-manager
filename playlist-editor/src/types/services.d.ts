...
interface Window {
  // Playlist endpoints
  ytCreatePlaylist: (title: string, privacyStatus?: "private" | "unlisted" | "public") => Promise<string>;
  ytUpdatePlaylist: (ytId: string, title: string) => Promise<void>;
  ytUpdatePlaylistPrivacy: (ytId: string, privacyStatus: "private" | "unlisted" | "public") => Promise<void>;
  ...
  ytMoveItem: (itemId: string, playlistId: string, videoId: string, position: number) => Promise<void>;
  ...
  ytListActivities: (maxResults?: number) => Promise<{ type: string; title: string; videoId?: string; channelId: string; timestamp: string }[]>;
  ytSearch: (query: string, maxResults?: number) => Promise<{ videoId: string; title: string; channelTitle: string; thumbnail: string; publishedAt: string; }[]>;
  ytListComments: (maxResults?: number) => Promise<{ id: string; textDisplay: string; videoId: string; authorDisplayName: string; publishedAt: string; }[]>;
...
type SavePlaylist = (playlist: Playlist, options?: { syncToYoutube?: boolean; resumeFromState?: SyncState }) => Promise<string>;
...
type GetAccountSubscriptions = () => Promise<{ channelId: string; title: string; thumbnail: string }[]>;
...
type YoutubeSearch = (query: string, maxResults?: number) => Promise<{
  videoId: string;
  title: string;
  channelTitle: string;
  thumbnail: string;
...
interface Window {
  ...
  ytListActivities: (maxResults?: number) => Promise<{ type: string; title: string; videoId?: string; channelId: string; timestamp: string }[]>;
  ytFetchVideoDurations: (videoIds: string[]) => Promise<Map<string, any>>;
  fetchVideoMetadataInvidious: (videoId: string, customPiped?: string[], customInvidious?: string[]) => Promise<{ title: string; channel: string; duration: string; lengthSeconds: number; viewCount?: number; publishedAt?: string; isPrivate?: boolean; isDeleted?: boolean; isBroken?: boolean; isLive?: boolean } | null>;
  fetchDurationsInvidious: (videoIds: string[], customPiped?: string[], customInvidious?: string[]) => Promise<Map<string, any>>;
  fetchVideoMetadataEmbedPage: (videoId: string) => Promise<{ title: string; channel: string; duration: string; lengthSeconds: number; viewCount?: number; publishedAt?: string; isPrivate?: boolean; isDeleted?: boolean; isBroken?: boolean; isLive?: boolean } | null>;
  fetchVideoMetadataOEmbed: (videoId: string) => Promise<{ title: string; channel: string; duration: string; lengthSeconds: number; viewCount?: number; publishedAt?: string; isPrivate?: boolean; isDeleted?: boolean; isBroken?: boolean; isLive?: boolean } | null>;
  fetchVideoMetadataInnertube: (videoId: string) => Promise<{ title: string; channel: string; duration: string; lengthSeconds: number; viewCount?: number; publishedAt?: string; isPrivate?: boolean; isDeleted?: boolean; isBroken?: boolean; isLive?: boolean } | null>;
  ...
  ensureWatchLaterPlaylist: (forceCreate?: boolean) => Promise<{ id: string | null; recreated: boolean }>;
...
interface Window {
  ...
  logSystemEvent: (level: "INFO" | "ERROR" | "WARN", message: string, details?: any) => Promise<void>;
