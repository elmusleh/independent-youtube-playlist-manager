...
Independent YouTube Playlist Manager is open-source software distributed under the [MIT License](LICENSE) — the complete codebase can be audited at [github.com/el-musleh/youtube-playlist-helper](https://github.com/el-musleh/youtube-playlist-helper).
