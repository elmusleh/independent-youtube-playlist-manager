# AMO Listed Submission — Metadata

Copy-paste the values below into the AMO **"Describe Add-on"** and **"Additional Details"** forms.

---

## Summary (English US)

YouTube playlist editor and manager. Build, edit, and sync playlists directly in your browser with local storage and optional YouTube sync.

> **AMO tip:** The Summary appears in search results and listings. Keep it under ~250 characters.
...
youtube, playlist, video, manager, editor, tool, productivity, helper
...
https://github.com/el-musleh/independent-youtube-playlist-manager/blob/main/docs/PRIVACY_POLICY.md
